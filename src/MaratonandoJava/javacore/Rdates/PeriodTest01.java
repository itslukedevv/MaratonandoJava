package MaratonandoJava.javacore.Rdates;
...
public class PeriodTest01 {
    public static void main(String[] args) {
        LocalDate nascimento = LocalDate.of(2005,1,5);
        Period tovivo1 = Period.between(nascimento, LocalDate.now());
